...
<head>
    ...
    <link rel="stylesheet" href="Paket_Silver.css" />
</head>
    ...
    <section class="header">
        <div class="homepage">
            ...
            <div class="texthome">
                ...
                <br /><br />
                <h6>
                    Paket Silver ini menyediakan paket tour dengan pilihan 5 Wisata +
                    Hotel + Makan. Wisata yang dituju adalah Lava Tour, Bungker
                    Kaliadem, Candi Prambanan, Keraton Yogyakarta, Pantai Parangtritis,
                    Dan Bonus Malioboro.
                </h6>
                <br /><br />
                <h6>Harga : Rp1.300.000 / tiket</h6>
