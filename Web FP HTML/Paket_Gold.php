...
<head>
    ...
    <link rel="stylesheet" href="Paket_Gold.css" />
</head>
    ...
    <section class="header">
        <div class="homepage">
            ...
            <div class="texthome">
                ...
                <br /><br />
                <h6>
                    Paket Gold ini menyediakan paket tour dengan pilihan 7 Wisata +
                    Hotel + Makan. Wisata yang dituju adalah Lava Tour, Bungker
                    Kaliadem, Candi Prambanan, Keraton Yogyakarta, Hutan Pinus Mangunan,
                    Tumpang Menoreh, Pantai Parangtritis, Dan Bonus Malioboro.
                </h6>
                <br /><br />
                <h6>Harga : Rp2.300.000 / tiket</h6>
